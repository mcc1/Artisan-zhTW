...
namespace Artisan.CraftingLists
{
    internal class CraftingListUI
    {
        ...
        {
            ImGui.TextWrapped($"制作清单是將不同的制作品按队列排序依次制作的绝佳方式。请使用底部的按鈕匯入Teamcraft清单来建立制作清单，或點擊「+」圖示並命名来建立制作清单。 你也可以右键點擊游戏配方選單中的某個物品，如果未選擇它，则將其添加到新清单中，或者如果未選擇清单，则將其作為第一個物品建立新清单。");
